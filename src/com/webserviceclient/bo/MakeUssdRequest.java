...
public class MakeUssdRequest  implements java.io.Serializable {
    ...
    /**
     * Gets the senderAddress value for this MakeUssdRequest.
     * 
    ...
    /**
     * Sets the senderAddress value for this MakeUssdRequest.
     * 
     * @param senderAddress
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:bo.webservice.inspur.com", "MakeUssdRequest"));
